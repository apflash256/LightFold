...
namespace lightfold {
    ...
    public:
        ...
        Vector2() = default;
        Vector2(T x, T y) : Tuple2<lightfold::Vector2, T>(x, y) {}

        template <typename U>
        explicit Vector2(Vector2<U> v) : Tuple2<lightfold::Vector2, T>(T(v.x), T(v.y)) {}
        template <typename U>
        explicit Vector2(Point2<U> p) : Tuple2<lightfold::Vector2, T>(T(p.x), T(p.y)) {}
    };
    ...
    public:
        ...
        Vector3() = default;
        Vector3(T x, T y, T z) : Tuple3<lightfold::Vector3, T>(x, y, z) {}

        template <typename U>
        explicit Vector3(Vector3<U> v) : Tuple3<lightfold::Vector3, T>(T(v.x), T(v.y), T(v.z)) {}
        template <typename U>
        explicit Vector3(Point3<U> p) : Tuple3<lightfold::Vector3, T>(T(p.x), T(p.y), T(p.z)) {}
        template <typename U>
        explicit Vector3(Normal3<U> n) : Tuple3<lightfold::Vector3, T>(T(n.x), T(n.y), T(n.z)) {}
    };
    ...
    public:
        ...
        template <typename U>
        explicit Point2(Vector2<U> v) : Tuple2<lightfold::Point2, T>(T(v.x), T(v.y)) {}
    ...
    inline Point2f InvertBilinear(Point2f p, pstd::span<const Point2f> v);
    ...
    public:
        ...
        template <typename U>
        explicit Point3(Vector3<U> v) : Tuple3<lightfold::Point3, T>(T(v.x), T(v.y), T(v.z)) {}
    ...
    public:
        ...
        Normal3() = default;
        Normal3(T x, T y, T z) : Tuple3<lightfold::Normal3, T>(x, y, z) {}

        template <typename U>
        explicit Normal3<T>(Normal3<U> v) : Tuple3<lightfold::Normal3, T>(T(v.x), T(v.y), T(v.z)) {}
        template <typename U>
        explicit Normal3<T>(Vector3<U> v) : Tuple3<lightfold::Normal3, T>(T(v.x), T(v.y), T(v.z)) {}
    };
    ...
    template <typename T>
    inline auto Dot(Normal3<T> n, Vector3<T> v) -> typename TupleLength<T>::type {
        return std::fma(n.x, v.x, SumOfProducts(n.y, v.y, n.z, v.z));
    }
    template <typename T>
    inline auto Dot(Vector3<T> v, Normal3<T> n) -> typename TupleLength<T>::type {
        return std::fma(n.x, v.x, SumOfProducts(n.y, v.y, n.z, v.z));
    }
    template <typename T>
    inline auto Dot(Normal3<T> n1, Normal3<T> n2) -> typename TupleLength<T>::type {
        return std::fma(n1.x, n2.x, SumOfProducts(n1.y, n2.y, n1.z, n2.z));
    }
    template <typename T>
    inline auto AbsDot(Normal3<T> n, Vector3<T> v) -> typename TupleLength<T>::type {
        return std::abs(Dot(n, v));
    }
    template <typename T>
    inline auto AbsDot(Vector3<T> v, Normal3<T> n) -> typename TupleLength<T>::type {
        return std::abs(Dot(v, n));
    }
    template <typename T>
    inline auto AbsDot(Normal3<T> n1, Normal3<T> n2) -> typename TupleLength<T>::type {
    ...
    inline Vector3f DirectionCone::ClosestVectorInCone(Vector3f wp) const {
        ...
        return cosTheta * w +
            (sinTheta / Length(a)) *
            Vector3f(w.x * (wp.y * w.y + wp.z * w.z) - wp.x * (w.y * w.y + w.z * w.z),
